...
# 8r2 = (-4*a^6 + 24*a^5 - 36*a^4 + 40*a^3 - 24*a^2 - 4)/b^2
# 8r1 = (32*a^5 - 64*a^4 + 64*a^3 - 32*a^2)/b^3
# 256r0 = (16*a^12 - 192*a^11 + 864*a^10 - 2048*a^9 + 2896*a^8 - 2496*a^7 + 1312*a^6 - 64*a^5 - 672*a^4 + 704*a^3 - 320*a^2 + 16)/b^4
# lc = b^9/(2*a^17 - 14*a^16 + 48*a^15 - 106*a^14 + 166*a^13 - 192*a^12 + 166*a^11 - 106*a^10 + 48*a^9 - 14*a^8 + 2*a^7)

# This gives you all possible rational values of a.  The idea is to kill off b
# and then use the lemma from the paper
f = (8*r2)*(8*r1)*(256*r0)*lc
a_set = get_vals(f)
