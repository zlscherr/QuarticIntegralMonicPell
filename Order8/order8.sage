...
# 8r2 = (16*a^4 + 16*a^3 - 64*a^2 + 32*a - 4)/(a^2*b^2)
# 8r1 = (64*a^2 - 96*a + 32)/b^3
# 256r0 = (256*a^8 - 1536*a^7 + 5376*a^6 - 9216*a^5 + 8576*a^4 - 4736*a^3 + 1536*a^2 - 256*a + 16)/(a^4*b^4)
# lc = a*b^16/(128*a^13 - 1280*a^12 + 5856*a^11 - 16224*a^10 + 30360*a^9 - 40512*a^8 + 39650*a^7 - 28814*a^6 + 15546*a^5 - 6150*a^4 + 1734*a^3 - 330*a^2 + 38*a - 2)
